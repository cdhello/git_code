...
class Codec():
    ...
    def __init__(self):
        ...
        #range_list = range(0,256)
        #while len(range_list):
        #    index = random.randint(0, len(range_list)-1)
        #    code = range_list[index]
        #
        #    self.encodebook.append(code)
        #    self.decodebook[code] =  self.encodebook.index(code)
        #
        #    range_list.remove(code)
        #print self.encodebook
        #print self.decodebook
